-- Migration 407: 12 new general_store categories, split out from the
-- original broad ones to match how a real Pakistani supermarket
-- organizes its shelves (checked live against Al-Fatah's actual
-- category structure — alfatah.pk) — Hair Care / Oral Care / Skin &
-- Bath Care out of Personal Care, Laundry & Detergents / Dishwashing /
-- Air Freshener & Insect Repellent / Tissue & Paper Products out of
-- Household & Cleaning, Diapers & Wipes / Baby Food & Feeding out of
-- Baby Care, plus Noodles & Pasta / Honey Jam & Spreads / Pickles
-- Ketchup & Sauces out of the food list. Purely additive — the original
-- broader categories (personal_care, household, baby_care) stay valid
-- and untouched, so no existing product's category ever goes stale;
-- these are just finer alternatives sitting alongside them now.
