...
interface Member {
  ...
  bio: string | null; bio_ur: string | null; display_order: number; is_active: boolean
...
const empty = {
  name: '', name_ur: '', position: '', position_ur: '', phone: '', bio: '', bio_ur: '', display_order: 0, is_active: true,
  admin_user_id: '', proxy_admin_user_id: '', uses_smartphone: true,
}
...
export default function AdminMembersPage() {
  ...
  const save = async () => {
    ...
    const payload = {
      ...
      admin_user_id: form.admin_user_id || null, proxy_admin_user_id: form.proxy_admin_user_id || null,
    }
  ...
  const edit = (m: Member) => {
    setForm({
      ...
      bio: m.bio ?? '', bio_ur: m.bio_ur ?? '', display_order: m.display_order, is_active: m.is_active,
