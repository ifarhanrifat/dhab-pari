  ...
  if (!access.canDonorsProjects) {
    return (
      <div className="bg-white rounded-lg border border-dp-outline-variant p-8 text-center">
        <p className="font-sans text-[14px] text-dp-on-surface-variant">{t('dcl.noAccessMessage')}</p>
      </div>
    )
  }
  ...
  return (
    <div dir={isUrdu ? 'rtl' : 'ltr'}>
      <div className="mb-6">
        ...
        <p className="font-sans text-[13.5px] text-dp-on-surface-variant mt-1">{t('dcl.subtitle')}</p>
      </div>
      ...
      <div className="bg-white rounded-lg border border-dp-outline-variant overflow-hidden mb-6">
        ...
        {loading ? (
          ...
          <p className="px-5 py-6 text-center font-sans text-[13.5px] text-dp-on-surface-variant">{t('dcl.noCollectorsYet')}</p>
        ) : (
