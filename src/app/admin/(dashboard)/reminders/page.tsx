...
import { BellRing, MessageCircle, SkipForward, Clock, AlertTriangle, Heart, CalendarClock, Copy } from 'lucide-react'
import { normalizePakPhone } from '@/lib/receiptExport'

interface Reminder {
  id: string; reminder_type: 'bill_weekly' | 'bill_defaulter' | 'donor_recurring' | 'meeting_due'
