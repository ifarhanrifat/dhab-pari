        ...
        <div className="fixed inset-0 bg-black/50 z-[100] flex items-center justify-center p-4" onClick={() => setShowManageRoles(false)}>
          <div className="bg-white rounded-lg p-6 w-full max-w-md" onClick={(e) => e.stopPropagation()}>
              ...
              {employeeRoles.map((r) => (
                <div key={r.key} className="flex items-center justify-between px-3 py-2 border border-dp-outline-variant rounded-lg">
                  <div>
                    ...
                    <p className="font-sans text-[12.5px] text-dp-on-surface-variant" style={{ fontFamily: 'var(--font-urdu-ui)' }}>{r.label_ur}</p>
                  </div>
            ...
            <div className="border-t border-dp-outline-variant pt-4 space-y-3">
              ...
              <input value={newRole.label_ur} onChange={(e) => setNewRole({ ...newRole, label_ur: e.target.value })} placeholder="اردو لیبل" dir="rtl" className="input-field" style={{ fontFamily: 'var(--font-urdu-ui)' }} />
      ...
      {loadingTemplates ? (
        ...
        <div className="space-y-4">
          <div>
            ...
            <textarea dir="rtl" value={bodies.requirements} onChange={(e) => setBodies({ ...bodies, requirements: e.target.value })} rows={3} className="input-field resize-none" style={{ fontFamily: 'var(--font-urdu-ui)' }} />
          </div>
          <div>
            ...
            <textarea dir="rtl" value={bodies.procedure} onChange={(e) => setBodies({ ...bodies, procedure: e.target.value })} rows={3} className="input-field resize-none" style={{ fontFamily: 'var(--font-urdu-ui)' }} />
          </div>
          <div>
            ...
            <textarea dir="rtl" value={bodies.skills} onChange={(e) => setBodies({ ...bodies, skills: e.target.value })} rows={3} className="input-field resize-none" style={{ fontFamily: 'var(--font-urdu-ui)' }} />
          </div>
