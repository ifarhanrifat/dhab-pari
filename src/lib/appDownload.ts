...
// whatever JDK is the machine's system default. Do a `clean` build after
// touching anything under node_modules/@capacitor (including
// scripts/patch-capacitor-camera.js's own postinstall patch) — Gradle's
// incremental build has been seen to silently keep a stale compiled
// copy of a capacitor-* module otherwise.
//
