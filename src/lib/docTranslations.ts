...
export const DOC_STRINGS = {
  ...
  discountAppliedColon: { en: 'Discount applied: − ', ur: 'دی گئی رعایت: − ' },
  ...
  opBalanceMismatchExpected: { en: 'Expected', ur: 'متوقع' },
  opBalanceMismatchLastReported: { en: "(last month's reported closing cash), but the ledger now shows", ur: '(پچھلے مہینے کی رپورٹ شدہ اختتامی نقدی)، لیکن لیجر اب یہ دکھا رہا ہے' },
